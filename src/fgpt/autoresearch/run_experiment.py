...
def run_experiment(
    ...
    cfg = FGPTConfig(gradient_checkpointing=True, rope_base=rope_base, parallel_attn_mlp=parallel_attn_mlp)
    model = FGPT(cfg)
    model.to("cuda")
...
def main():
    ...
    parser.add_argument("--parallel-attn-mlp", action="store_true", default=False)
    ...
    run_experiment(
        ...
        parallel_attn_mlp=args.parallel_attn_mlp,
