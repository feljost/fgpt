...
| 2 | `exp-019-muon-lr-030` | 4.2114 | Muon LR 0.030 on compound baseline |
| 3 | `exp-018-compound-geglu` | 4.2176 | GeGLU on parallel+n16 baseline |
| 4 | `exp-007-parallel-attn-mlp` | 5.1336 | Parallel attn+MLP (PaLM style) |
| 5 | `exp-009-n-head-16` | 5.3510 | 16 heads instead of 24 (larger head_dim) |
| 6 | `exp-016-no-weight-tying` | 5.3643 | Untied lm_head and wte weights |
| 7 | `exp-008-geglu` | 5.3875 | GeGLU instead of SwiGLU |
| 8 | `exp-003-muon-lr-025` | 5.3898 | Muon LR 0.025 (higher) |
| 9 | `exp-015-weight-decay-005` | 5.3914 | Weight decay 0.05 instead of 0.1 |
| 10 | `exp-010-logit-softcap` | 5.3939 | Soft-cap logits at 30 (Gemma 2 style) |
| 11 | `exp-005-rope-base-100k` | 5.4097 | RoPE base 100k (LLaMA-3 style) |
| 12 | `exp-002-lr-adamw-3e4` | 5.4101 | AdamW LR 3e-4 vs 2e-4 |
| 13 | `exp-004-muon-lr-015` | 5.4718 | Muon LR 0.015 (lower) |
| 14 | `exp-000-baseline` | 5.5235 | current config unchanged |
| 15 | `exp-001-warmup-longer` | 5.5596 | 10% warmup instead of 5% |
| 16 | `exp-006-qk-norm` | 5.6449 | QK normalization per-head |
| 17 | `exp-011-z-loss` | 5.7478 | Auxiliary z-loss on logits (1e-4) |
